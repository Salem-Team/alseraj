...
Portfolio اسلام علاء عبدالرحمن العربيةجمهورية مصر - البحيره
eslamabosife69@gmail.com https://github.com/eslam1abosife الملخص المهني سنة مطور
برامج ذو خبرة في تطوير تطبيقات الويب باستخدام تقنيات مثل .Vue.js و JavaScript
ماهر في تطوير واجهات المستخدم وتكامل قواعد البيانات، يتمتع بقدرة على حل المشكلات
وتقديم حلول برمجية مبتكرة. الخبرات العملية Intern Full Stack Web developer سالم
تيم - مارس 2024 - مستمر - تطوير وصيانة تطبيقات ويب باستخدام Vue.js. - تنفيذ
واجهات مستخدم ديناميكية وقابلة للتكيف مع مختلف الأجهزة. - العمل ضمن فريق لتطوير
تطبيقات ويب تعتمد على تقنيات الواجهة الأمامية و JavaScript. - تكامل خدمات
Firebase للمصادقة وتخزين البيانات في الوقت الحقيقي. - تحسين تجربة المستخدم من
خلال تنفيذ تصميمات واجهات تفاعلية وجذابة. التعليم كليه الهندسه جامعه طنطا
https://github.com/eslam1abosife المهارات - لغات البرمجة: JavaScript، HTML، CSS
- أطر العمل: Vue.js - قواعد البيانات: Firebase - أدوات التحكم في الإصدارات: Git،
GitHub - أدوات التطوير: Postman الشهادات والدورات - Software Engineering (2022)
- Web Development (2021) المشاريع ella-ecommre مشروع
https://github.com/eslam1abosife/ella-ecommre - مشروع فريق: موقع معهد السراج
المنير التقنيات المستخدمة: HTML, CSS, Vuetify, vue.js, firebase هو موقع مدرسة
يمكن المشرفين والطلاب وأولياء الأمور من متابعة الأمور التعليمية والفعاليات
والاختبارات والدرجات. https://alseraj.vercel.app - مشروع فريق: Awn (موقع)
التقنيات المستخدمة: HTML, Tailwind CSS, JavaScript, VUE, Vuetify هو منصة
للجمعيات الخيرية لمساعدة المحتاجين ومساعدة الجمعيات الخيرية والمشرفين على تتبع
أعمالهم. https://awon.site - مشروع فريق: موقع العقارات التقنيات المستخدمة: HTML,
Tailwind CSS, VUE يقدم موقع العقارات الحقيقية قوائم مفصلة للممتلكات، ويسلط الضوء
على العقارات الأعلى مبيعاً، ويوفر مدونات معلوماتية، ويقدم فريق الشركة، ويسهل
التواصل مع العملاء. https://real-estate-salem-team.vercel.app - مشروع فريق: موقع
المطعم التقنيات المستخدمة: HTML, CSS, JavaScript, Bootstrap موقع مصمم لعرض عروض
المطاعم، بما في ذلك قائمتها ونظام الحجز. https://restaurant-ruddy-ten.vercel.app
اللغات - اللغة العربية (اللغة الأم) - اللغة الإنجليزية (الاحتراف الكامل في
المستوى المهني)
