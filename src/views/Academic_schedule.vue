        ...
        <div>
            <div class="visible">
                <div class="right">
                    <div>
                        <v-breadcrumbs>
                            ...
                            <v-breadcrumbs-item>
                                الجدول الدراسي</v-breadcrumbs-item
                            >
                        </v-breadcrumbs>
                    </div>
                </div>
                <div class="schedule">
                    ...
                    <div class="time_2">
{{
    fetchedSchedule && fetchedSchedule.lastModified ? 
    new Date(
        fetchedSchedule.lastModified.seconds * 1000
        ...
        hour12: true,
                    ...
                    <div style="overflow: auto; width: 100%">
                        <table class="schedule_table" v-if="fetchedSchedule">
                            <thead>
                                <tr>
                                    <th>الأيام</th>
                            ...
                            <tbody>
                                <tr
                                    v-for="day in fetchedSchedule.schedule"
                                    :key="day.day"
                                >
                                    <td>{{ day.day }}</td>
                                    <td
