    ...
    <div class="visible">
            ...
            <div class="left">
                <v-menu>
                    ...
                    <v-list style="padding: 10px">
                        ...
                        >
                            <v-list-item-title v-if="empty0 === false">{{
                                notification.text
                            }}</v-list-item-title>
                        </v-list-item>
                    </v-list>
        ...
        <v-dialog v-model="dialog_1" width="90%">
            <v-card width="100%" class="popup">
                ...
                <form
                    ref="form"
                    @submit.prevent="jobs.Update_Jobs(jobs.Id_Information)"
                    class="ma-auto mt-4"
                >
                    <v-text-field
            ...
            <div class="feat" v-for="Job in Jobs" :key="Job.id">
                ...
                <v-dialog v-model="jobs.dialog_4" width="90%">
                    <v-card width="100%" class="popup">
                        ...
                        <div v-if="loading3" style="height: 200px !important">
                            <svg
                                style="
                                    position: absolute;
                                    top: 50%;
                        ...
                        />
                        <v-container
                            v-if="(empty1 === false, loading3 === false)"
                            style="
